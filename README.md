...
| [`docs`](plugins/docs/) | `document-codebase` | Write a repository's architecture documentation from its real dependency graph, with every structural claim checked against that graph before it ships |
